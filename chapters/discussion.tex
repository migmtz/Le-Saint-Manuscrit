...
Finally, in the context of subsampling through thinning, a significant issue concerns the lack of evaluation methods for spectral estimators in unsupervised settings.
