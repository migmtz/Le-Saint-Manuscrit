...
\begin{theorem}[{\cite[Theorem 7.4.IV]{DaleyV1}}]\label{th:chap2_real_time_change}
...
\end{tabular}
\caption{
\change{Quantitative assessment of the numerical study: sets of true parameters (left), average estimations over 50 repetitions (middle) and average \(p\)-values over 50 independent realisations for the test of Section~\ref{sec:chap2_goodness}}.
}
